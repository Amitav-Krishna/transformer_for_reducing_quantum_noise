"""
Train MLP on 8-qubit dataset WITH FROBENIUS NORMALIZATION.

Uses StreamingChunkDataset to avoid OOM on large 8-qubit dataset.

Usage:
    python train_17/train/train_mlp_8q.py
"""
...
def main():
    ...
    ckpt_dir = os.path.join(base_dir, "checkpoints_17", "mlp_8q")
    os.makedirs(ckpt_dir, exist_ok=True)
    csv_logger = CSVLogger(csv_dir=os.path.join(base_dir, "csvs_17"), name="mlp_8q")
    ...
    print(f"\n{'=' * 60}")
    print(f"Training MLP 8-qubit (v17 - Streaming + Frobenius)")
