"""
Train Wide MLP on 5-qubit dataset WITH FROBENIUS NORMALIZATION.

Usage:
    python train_17/train/train_mlp_wide.py
"""
...
def main():
    ...
    ckpt_dir = os.path.join(base_dir, "checkpoints_17", "mlp_wide")
    os.makedirs(ckpt_dir, exist_ok=True)
    csv_logger = CSVLogger(csv_dir=os.path.join(base_dir, "csvs_17"), name="mlp_wide")
    ...
    print(f"\n{'=' * 60}")
    print(f"Training MLP Wide (v17 - Frobenius normalized)")
