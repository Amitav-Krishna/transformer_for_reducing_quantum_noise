...
\hyperref[sec:org3843cdf]{\uline{Introduction 1}}

\hyperref[sec:org3120963]{\uline{Methods 1}}

\begin{quote}
\hyperref[sec:org19fdb20]{\uline{2.1
Quantum Circuit Dataset Generation and Density Matrix Extraction 1}}

\hyperref[sec:orgf3838f2]{\uline{2.2 Noise Modelling 2}}

\hyperref[sec:org9d70621]{\uline{2.3 Transformer architecture 2}}

\hyperref[sec:orgf104f07]{\uline{2.4 Physics-informed loss 2}}

\hyperref[sec:org664ce4d]{\uline{2.5 Training 3}}
\end{quote}

\hyperref[sec:org52e260e]{\uline{Analysis 3}}

\hyperref[sec:org47b2390]{\uline{Related Implementations 4}}

\hyperref[sec:org44fd75c]{\uline{Conclusion 5}}
\section{Introduction}
\label{sec:org3843cdf}
...
\section{Analysis}
\label{sec:org52e260e}
\subsection{Performance}
\label{sec:orgf48187f}
