"""
Evaluate transformer_matched_v4 models per noise type and level.

Run after training completes:
    python eval_transformer_matched_v4_per_noise_cell.py

Outputs:
    - csvs_2/noise_cells/transformer_matched_v4_frob_noise_cells.csv
    - csvs_2/noise_cells/transformer_matched_v4_physics_noise_cells.csv
"""
