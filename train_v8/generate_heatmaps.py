#!/usr/bin/env python3
"""Generate per-noise-cell Uhlmann fidelity heatmaps for v8."""
...
def make_heatmap(csv_path, model_name, out_path, vmin=0, vmax=0.75):
...
# Generate heatmaps from v8 noise_cells CSVs
INPUT_DIR = "train_v8/csvs_8/noise_cells"
models = {
