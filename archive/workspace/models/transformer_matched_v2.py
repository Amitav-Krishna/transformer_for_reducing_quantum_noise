...
class TransformerAutoencoderMatchedV2(nn.Module):
    """
    Transformer autoencoder with ~750k parameters to match CNN capacity.

    V2 fixes the bottleneck: 96->48->96 instead of 96->16->96.
    The original bottleneck was too aggressive (83% compression) and
    prevented the model from learning.

    embed_dim=96, ffn_dim=128, bottleneck_dim=48
    """
    ...
    def __init__(self, loss_fn=None):
        ...
        self.embed_dim = 96
        self.ffn_dim = 128
        self.bottleneck_dim = 48  # Fixed: was 16, now 48 (50% compression like small transformer)
        self.num_heads = 4
        self.layers = 4
        ...
        # Fixed bottleneck: 96 -> 48 -> 96 (50% compression, matching small transformer's ratio)
