"""
Evaluate transformer_matched_v2 models per noise type and level.

Run after training completes:
    python eval_transformer_matched_v2_per_noise_cell.py

Outputs:
    - csvs_2/noise_cells/transformer_matched_v2_frob_noise_cells.csv
    - csvs_2/noise_cells/transformer_matched_v2_physics_noise_cells.csv
"""
