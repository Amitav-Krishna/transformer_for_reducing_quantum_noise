"""
Evaluate transformer_matched_v3 models on Uhlmann fidelity.

Run after training completes:
    python eval_transformer_matched_v3_uhlmann.py

Outputs:
    - Prints mean Uhlmann fidelity for both variants
    - Saves to csvs_2/transformer_matched_v3_uhlmann_results.csv
"""
...
def main():
    ...
    if results:
        ...
        df.to_csv("csvs_2/transformer_matched_v3_uhlmann_results.csv", index=False)
        print(f"\nResults saved to csvs_2/transformer_matched_v3_uhlmann_results.csv")
