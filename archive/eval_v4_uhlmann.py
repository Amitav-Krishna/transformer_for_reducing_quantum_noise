"""
Evaluate v4 models on Uhlmann fidelity with post-hoc projection.
...
def main():
    ...
    for name, config in EXPERIMENTS.items():
        arch = config["arch"]
        ckpt_path = f"checkpoints_4/{name}/best.pt"
    ...
    # Summary table
    print(f"\n{'='*50}")
    print("SUMMARY: Uhlmann Fidelity on Test Set (v4 Models)")
    print(f"{'='*50}")
