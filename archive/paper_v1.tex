...
\hyperref[sec:org298a5de]{\uline{Introduction 1}}

\hyperref[sec:org7ce293c]{\uline{Methods 1}}

\begin{quote}
\hyperref[sec:org911f32a]{\uline{2.1
Quantum Circuit Dataset Generation and Density Matrix Extraction 1}}

\hyperref[sec:org345dd43]{\uline{2.2 Noise Modelling 2}}

\hyperref[sec:org8be2720]{\uline{2.3 Transformer architecture 2}}

\hyperref[sec:org2e0e959]{\uline{2.4 Physics-informed loss 2}}

\hyperref[sec:orge04c183]{\uline{2.5 Training 3}}
\end{quote}

\hyperref[sec:orgba5ec3b]{\uline{Analysis 3}}

\hyperref[sec:org7f50c90]{\uline{Related Implementations 4}}

\hyperref[sec:orgb46cfb1]{\uline{Conclusion 5}}
\section{Introduction}
\label{sec:org298a5de}
...
\section{Analysis}
\label{sec:orgba5ec3b}
\subsection{Performance}
\label{sec:org97d1dbc}
