...
def matrix_sqrt(A):
    ...
    # Cast to complex to match eigenvectors dtype
...
def uhlmann_fidelity_batch(rho_pred, rho_true, eps=1e-10):
    ...
    """
    # Convert to complex matrices (B, 32, 32)
...
def main():
    ...
    for name, config in EXPERIMENTS.items():
        arch = config["arch"]
        ckpt_path = f"checkpoints_2/{name}/best.pt"
    ...
    # Summary table
    print(f"\n{'='*50}")
    print("SUMMARY: Uhlmann Fidelity on Test Set")
    print(f"{'='*50}")
