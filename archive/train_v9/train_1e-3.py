"""
Train Wide MLP with weight_decay=1e-3 and batch_size=16.

Reduced batch size to avoid OOM/crashes.

Usage:
    python train_v9/train_1e-3.py
"""
...
def train_mlp_wide(train_chunks, val_chunks, device):
    """Train the wide MLP with weight_decay=1e-3 and batch_size=16."""
    weight_decay = 1e-3
    name = "mlp_wide_wd1e-03"
    ...
    BATCH = 16  # Reduced from 64 to avoid OOM
...
def main():
    ...
    # Train with weight_decay=1e-3
    train_mlp_wide(train_chunks, val_chunks, device)

    print("\n" + "="*60)
    print("Training complete!")
    print("Checkpoints saved to: checkpoints_9/mlp_wide_wd1e-03/")
