...
\section{Methods}
\label{sec:org8c6c2a2}
\subsection{Dataset}
\label{sec:orgd8f7059}
...
\label{sec:org7467189}
\section{Experimental Design}
\label{sec:org2831fa3}
...
\label{sec:org2ecdd90}

\subsubsection{Shared Hyperparameters}
\label{sec:org06324e3}
...
\label{sec:orgecca7a9}
\subsubsection{It was an RTX A4000}
\label{sec:org561f7b3}
\newpage
\section{Results}
\label{sec:orgc108e44}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{org60aa10d}Reconstruction losses are only comparable within the same loss family (Frobenius vs. Frobenius, Physics vs. Physics). Cross-family comparisons have no physical meaning.}
...
\caption{\label{fig:org4238116}Baseline Uhlmann fidelity between noisy inputs and clean target states across noise types and levels. Lower values indicate more severe corruption.}
\end{figure}
...
\caption{\label{fig:orgbfc5a9e}Reconstruction fidelity comparison. The baseline (gray) shows the fidelity of noisy inputs to clean targets. The Frobenius-trained transformer achieves near-perfect reconstruction (+0.84 improvement), while the physics-informed CNN performs worse than doing nothing.}
\end{figure}
...
\section{References}
\label{sec:orgcc932a7}
\printbibliography
\subsection{{\bfseries\sffamily TODO} Add more citations}
\label{sec:orga624160}
\section{Appendix}
\label{sec:orgb768828}
\end{document}
